...
Пошаговый обзор по направлениям: что уже хорошо, что можно усилить. Выбирай пункты по приоритету — буду рад помочь реализовать.
...
| **Health check** | Нет | Endpoint `GET /health` (200 + проверка БД), для Docker/K8s и мониторинга. |
