(function () {
  ...
  // Dial load animation (main page only): holes appear, then center flies up into header logo
  var heroDial = document.querySelector('.hero-dial');
  if (heroDial) {
    document.body.classList.add('dial-animate');
    setTimeout(function () {
      document.body.classList.add('dial-center-fly');
    }, 900);
    setTimeout(function () {
      document.body.classList.add('dial-loaded');
    }, 2000);
  }
})();
