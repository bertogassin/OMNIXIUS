(function () {
  ...
  const strings = {
    en: {
      ...
      apiUrlExplain: 'Paste the URL of your API (e.g. from Railway, Render, or your server). Then click the button below.',
      email: 'Email',
      password: 'Password',
    ...
    ru: {
      ...
      apiUrlExplain: 'Вставьте URL вашего API (например с Railway, Render или вашего сервера), затем нажмите кнопку ниже.',
      email: 'Email',
      password: 'Пароль',
