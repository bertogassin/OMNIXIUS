(function () {
  ...
  const strings = {
    en: {
      ...
      apiUrlExplain: 'To sign in from this site you need a deployed backend. Paste its URL (e.g. https://your-app.onrender.com) or run the app locally with "go run ." in backend-go. Then click the button below.',
      apiUrlPlaceholder: 'https://your-api.onrender.com',
      saveApiUrl: 'Save',
      email: 'Email',
      password: 'Password',
    ...
    ru: {
      ...
      apiUrlExplain: 'Чтобы войти с этого сайта, нужен развёрнутый бэкенд. Вставьте его URL (например https://your-app.onrender.com) или запустите приложение локально: в папке backend-go выполните "go run .". Затем нажмите кнопку ниже.',
      apiUrlPlaceholder: 'https://your-api.onrender.com',
    ...
    fr: {
      ...
      apiUrlExplain: 'Collez l\'URL de votre API (ex. Railway, Render ou votre serveur), puis cliquez sur Enregistrer.',
      apiUrlPlaceholder: 'https://votre-api.onrender.com',
